...
| `pyvar-grant-brief-nlnet.docx` | The same brief adapted for NLnet Foundation — check its own "before you submit" note for a caveat on NLnet's fund lineup. |
| `pyvar-monetization-strategy.docx` | Open-core/support sustainability model — how pyvar funds its own infrastructure without narrowing the MIT licence. |
...
| `marketplace-submission-content.md` | Prepared content for submitting pyvar's plugin marketplace to Anthropic's official Claude Code plugin directory. |
