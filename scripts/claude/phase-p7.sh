#!/bin/bash
# pyvar.com Phase P7 — UNIFIED v3
# Cost & Performance Optimisation | Wk 18-22 | Agent Teams: ❌ DISABLED
# Usage: ./phase-p7.sh [--dry-run|--status|--at-only]
set -euo pipefail
...
echo "╔══════════════════════════════════════════════════════╗"
echo "║ pyvar · P7: Cost & Performance Optimisation            ║"
echo "║ Wk 18-22   · Agent Teams: ❌ DISABLED           ║"
echo "╚══════════════════════════════════════════════════════╝"
echo ""
# Optimisation: autoresearch loop, scientific, ln-620-auditor, app-performance. AT OFF.
echo ""
...
run claude plugins enable application-performance@claude-code-workflows
...
echo ""
echo "✓ P7 done: 20 enabled | 28 disabled | 2 never"
echo "  12 original | 1 wshobson | 7 zip-new | AT: ❌ DISABLED"
