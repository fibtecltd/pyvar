#!/bin/bash
# pyvar.com Phase P8 — UNIFIED v3
# Portal Finalisation | Wk 20-24 | Agent Teams: ❌ DISABLED
# Usage: ./phase-p8.sh [--dry-run|--status|--at-only]
set -euo pipefail
...
echo "╔══════════════════════════════════════════════════════╗"
echo "║ pyvar · P8: Portal Finalisation                        ║"
echo "║ Wk 20-24   · Agent Teams: ❌ DISABLED           ║"
echo "╚══════════════════════════════════════════════════════╝"
echo ""
# Portal: frontend-design, mobile, ln-100-docs. Shared CSS — AT OFF.
echo ""
...
install_if_missing "ln-100-documents-pipeline@levnikolaevich-skills-marketplace"
...
run claude plugins enable code-documentation@claude-code-workflows
...
run claude plugins enable documentation-generation@claude-code-workflows
echo "  ✅ [official ] frontend-design"
run claude plugins enable frontend-design@claude-plugins-official
echo "  ✅ [workflow ] frontend-mobile-development"
run claude plugins enable frontend-mobile-development@claude-code-workflows
...
run claude plugins enable ln-100-documents-pipeline@levnikolaevich-skills-marketplace
...
echo ""
echo "✓ P8 done: 12 enabled | 36 disabled | 2 never"
echo "  9 original | 0 wshobson | 3 zip-new | AT: ❌ DISABLED"
